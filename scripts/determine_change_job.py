...
class DetermineChangePipeline:
    ...
    def __init__(self, env: StreamExecutionEnvironment, changes_source: FlinkKafkaConsumer):
        self.changes = (
            env
            .add_source(changes_source)
            .name("consuming enriched atlas events determine_change")
