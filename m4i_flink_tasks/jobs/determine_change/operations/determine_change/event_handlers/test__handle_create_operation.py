...
def test_handle_create_operation_no_attributes_relationships():
    entity = {
...
def test_handle_create_operation_attributes_only():
    entity = {
        "type_name": "SampleEntity",
...
def test_handle_create_operation_relationships_only():
    entity = {
        "type_name": "SampleEntity",
        "relationship_attributes": {
            "relation1": [
...
def test_handle_create_operation_both_attributes_relationships():
    entity = {
        "type_name": "SampleEntity",
