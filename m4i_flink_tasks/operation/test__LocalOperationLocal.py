...
def test__map_local11(store):
	...
	kafka_message =  '{"id": "b5784360-add3-4f4d-bb94-e7c56aa813ce", "creationTime": 1666268443298, "entityGuid": "58b5d7fc-5a5b-4cfa-a874-d067447a289e", "changes": {"propagate": true, "propagateDown": true, "operation": {"py/object": "m4i_flink_tasks.operation.core_operation.Sequence", "name": "propagated downwards operation", "steps": [{"py/object": "m4i_flink_tasks.operation.core_operation.Delete_Hierarchical_Relationship", "name": "delete hierarchical relationship", "parent_entity_guid": "3a2429e1-d80f-4beb-a59f-e8f4f21b4d4b", "child_entity_guid": "58b5d7fc-5a5b-4cfa-a874-d067447a289e", "current_entity_guid": "58b5d7fc-5a5b-4cfa-a874-d067447a289e", "derived_guid": "deriveddatadomainguid"}]}}}'
	local_operation_local = LocalOperationLocal()
	local_operation_local.open_local(config, credentials,store)
